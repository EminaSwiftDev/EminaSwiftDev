...
// MARK: - Конфиг сервера
enum RemoteConfig {
    static let endpointURL = "https://kvasscraftfermentorialab.com/lander/new-ios-server/server.php"
    static let accessKey   = "qTr8LmXzP4nVbK7"
...
//        Task {
            await fetchDecision(from: reqURL)
